...
class KoreanConversationSummary(DataDownload) :
    ...
    def download_(self,root_dir = None):
        if not self.check_canard_(): 
            ...
            base_url = "https://air.changwon.ac.kr/~airdemo/storage/data/자연어 데이터/한국어 대화 요약.zip"
            print("Downloading...")
...
if __name__ == '__main__':
    korean_conversation_summary =KoreanConversationSummary() 
    korean_conversation_summary.download_() 
